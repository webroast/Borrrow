  ...
  return (
    <>
      <style>{`
        ...
        .register-whatsapp-check label {
          color: rgba(255,255,255,0.8);
          font-size: 0.88rem;
          margin: 0;
        }

        .register-whatsapp-check i {
          color: #25D366;
          font-size: 1.1rem;
        }
      ...
      {/* ✅ Only Top White Bar — no hero video/image from Header */}
      ...
      <div className="register-hero-wrapper">
        ...
        {/* Background Image */}
        <img
          src="https://images.unsplash.com/photo-1579621970588-a35d0e7ab9b6?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
